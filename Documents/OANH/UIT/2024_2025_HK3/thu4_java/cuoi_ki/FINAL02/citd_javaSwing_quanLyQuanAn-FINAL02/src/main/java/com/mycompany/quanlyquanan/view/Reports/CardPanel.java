...
public class CardPanel extends javax.swing.JPanel {
    ...
    public void initCardData(){
        ...
        card1.setData(new ModelCard("Total Income", totalIncome, icon1));
        ...
        card2.setData(new ModelCard("Total Expense", totalExpense, icon2));
        ...
        card3.setData(new ModelCard("Total Revenue", revenue, icon3));
