...
import com.mycompany.quanlyquanan.controller.Nhu_ExpenseController;
import com.mycompany.quanlyquanan.controller.Nhu_OrderController;
...
public class TabbedPane2 extends javax.swing.JPanel {
    Nhu_ExpenseController expenseController;
    Nhu_OrderController orderController;
    DishController dishController;

    DefaultTableModel yearOrderTableModel, monthOrderTableModel, dayOrderTableModel, todayTableModel;
    DefaultTableModel yearDishesTableModel, monthDishesTableModel, dayDishesTableModel; // Table 2 tab Daily, Monthly, Annual Report
    ...
    public TabbedPane2() {
        ...
        orderController = new Nhu_OrderController();
        expenseController = new Nhu_ExpenseController();
...
//        initTodayCardData(); // TodayCardData lấy từ dashboardCard (cardPanel) nên không nằm ở đây
    ...
    private void initTodayTableData() {
        // Format table
        todayTableModel = setUpOrderTable(todayTable1);

        // Fetch top highest orders today
        List<Nhu_ModelOrder> orders = orderController.getDayTopOrderByAmount(LocalDate.now());
        setTodayOrderTableData(todayTableModel, orders);
    }
    ...
    private void setTodayOrderTableData(DefaultTableModel tableModel, List<Nhu_ModelOrder> orders) {
        tableModel.setRowCount(0);
        for (Nhu_ModelOrder order : orders) {
...
//        initDailyDishesTableData();
    ...
    private void refreshDailyReportData(LocalDate selectedDate) {
        ...
        List<Nhu_ModelOrder> orders = orderController.getDayTopOrderByAmount(selectedDate);
    ...
    private void setDailyCardData() {
        ...
        dayCard1.setData(new ModelCard("Income", dayIncome, incomeIcon));
        dayCard2.setData(new ModelCard("Expense", dayExpense, expenseIcon));
        dayCard3.setData(new ModelCard("Revenue", dayRevenue, revenueIcon));
    }
    ...
    private void setDailyOrderTableData(DefaultTableModel tableModel, List<Nhu_ModelOrder> orders) {
        tableModel.setRowCount(0);
        for (Nhu_ModelOrder order : orders) {
            tableModel.addRow(new Object[]{
                    order.getId(),
...
//        dayDishesTableModel = setUpOrderTable(dayTable2);
//        List<Dish> dishes = dishController.getDayTopDishesByAmount(); // Giả sử bạn có phương thức này để lấy danh sách món ăn
//        setDailyDishesTableData(dayDishesTableModel, dishes);
//    }

    private void setDailyDishesTableData(DefaultTableModel tableModel, List<Dish> dishes) {
        tableModel.setRowCount(0);
...
//        monthTable2.fixTable(monthScroll2);
    ...
    private void refreshMonthlyReportData() {
        ...
        List<Nhu_ModelOrder> monthOrders = orderController.getMonthTopOrderByAmount(selectedMonth, selectedYear);
    ...
    private void setMonthlyCardData() {
        ...
        monthCard1.setData(new ModelCard("Income", monthIncome, incomeIcon));
        monthCard2.setData(new ModelCard("Expense", monthExpense, expenseIcon));
        monthCard3.setData(new ModelCard("Revenue", monthRevenue, revenueIcon));
    }
    ...
    public void initMonthlyChartData() {
        ...
        for (int i = 0; i < 6; i++) {
            int chartMonth = startDate.getMonth().getValue() + i;
            int chartYear = startDate.getYear();
            double monthExpense = expenseMap.getOrDefault(chartMonth, 0.0);
            double monthIncome = incomeMap.getOrDefault(chartMonth, 0.0);
            double monthRevenue = monthIncome - monthExpense;
            monthChart.addChartData(new ModelChart(chartMonth + "-" + chartYear, new double[]{monthExpense, monthIncome, monthRevenue}));
        }
    }
...
//        table1.addRowSelectionInterval(new ModelVoucher);
        ...
        List<Nhu_ModelOrder> orders = orderController.getMonthTopOrderByAmount(selectedMonth, selectedYear);
        setMonthlyOrderTableData(monthOrderTableModel,orders);
    }


    private void setMonthlyOrderTableData(DefaultTableModel tableModel, List<Nhu_ModelOrder> orders) {
//        List<Nhu_ModelOrder> orders = orderController.getMonthTopOrderByAmount(selectedMonth, selectedYear);
        tableModel.setRowCount(0);
        for (Nhu_ModelOrder order : orders) {
            tableModel.addRow(new Object[]{
    ...
    private void refreshYearReportData(int selectedYearAnnualReport) {
        ...
        List<Nhu_ModelOrder> yearOrders = orderController.getYearTopOrderByAmount(selectedYearAnnualReport);
    ...
    private void setYearCardData() {
        ...
        yearCard1.setData(new ModelCard("Income", yearIncome, incomeIcon));
        yearCard2.setData(new ModelCard("Expense", yearExpense, expenseIcon));
        yearCard3.setData(new ModelCard("Revenue", yearRevenue, revenueIcon));
    }
    private void initYearChartData() {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            double yearRevenue = yearIncome - yearExpense;
            yearChart.addChartData(new ModelChart(String.valueOf(chartYear), new double[]{yearExpense, yearIncome, yearRevenue}));
        }
    }
    ...
    private void initYearTable1Data() {
        yearOrderTableModel = setUpOrderTable(yearTable1);
        List<Nhu_ModelOrder> orders = orderController.getYearTopOrderByAmount(selectedYearAnnualReport);
        setYearOrderTableData(yearOrderTableModel, orders);
    }

    private void setYearOrderTableData(DefaultTableModel tableModel, List<Nhu_ModelOrder> orders) {
//        List<Nhu_ModelOrder> orders = orderController.getYearTopOrderByAmount(selectedYearAnnualReport);
        tableModel.setRowCount(0);
        for (Nhu_ModelOrder order : orders) {
            tableModel.addRow(new Object[]{
    ...
    private void initComponents() {
        ...
        dashboardChartTitle.setText("Sales by Day");
        ...
        dashboardTable1Title.setText("Highest Amount Orders of Today");
        ...
        dashboardTable2Title.setText("Popular Dishes of Today");
                ...
                .addGroup(dashboardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(dashboardLayout.createSequentialGroup()
                        ...
                        .addGroup(dashboardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(dashboardChart, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 672, javax.swing.GroupLayout.PREFERRED_SIZE))))
            ...
            .addGroup(dashboardLayout.createSequentialGroup()
                ...
                .addGroup(dashboardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(dashboardLayout.createSequentialGroup()
                        ...
                        .addComponent(dashboardChartTitle)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(dashboardChart, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        dayChartTitle.setText("Sales by Day");
        ...
        dayTable1Title.setText("Highest Amount Orders of the day");
        ...
        dayTable2Title.setText("Popular Dishes of the day");
                ...
                .addGroup(dayTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(dayTabLayout.createSequentialGroup()
                        .addGroup(dayTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(dayScroll1, javax.swing.GroupLayout.DEFAULT_SIZE, 355, Short.MAX_VALUE))
                        .addContainerGap())
        ...
        MonthChartTitle.setText("Sales by Month");
        ...
        MonthTable1Title.setText("Highest Amount Orders of the month");
        ...
        MonthTable2Title.setText("Popular Dishes of the month");
        ...
        YearChartTitle.setText("Sales by Month");
        ...
        yearTable1Title.setText("Highest Amount Orders of the year");
        ...
        YearTable2Title.setText("Popular Dishes of the year");
                ...
                .addGroup(yearTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(yearTabLayout.createSequentialGroup()
                        .addGroup(yearTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(yearScroll2, javax.swing.GroupLayout.DEFAULT_SIZE, 349, Short.MAX_VALUE))
                        .addContainerGap())
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tabs, javax.swing.GroupLayout.DEFAULT_SIZE, 1047, Short.MAX_VALUE))
            .addGroup(layout.createSequentialGroup()
                .addGap(30, 30, 30)
