...
public class CreateTableDialog extends javax.swing.JDialog {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CreateTableDialog.class.getName());
    ...
    public CreateTableDialog(java.awt.Frame parent, boolean modal, QuanLyBanPanel parentPanel) {
        super(parent, modal);
        initComponents();
...
// Gọi controller
        boolean success = controller.addTable(table);
        if (success) {
