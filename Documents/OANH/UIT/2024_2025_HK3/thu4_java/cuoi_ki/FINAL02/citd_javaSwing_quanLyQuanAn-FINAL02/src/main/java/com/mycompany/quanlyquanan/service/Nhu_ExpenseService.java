...
import com.mycompany.quanlyquanan.dao.Nhu_ExpenseDAO;

import java.time.LocalDate;
import java.util.Map;

public class Nhu_ExpenseService {
    private Nhu_ExpenseDAO expenseDAO;

    public Nhu_ExpenseService() {
        this.expenseDAO = new Nhu_ExpenseDAO();
    }
