    ...
    public boolean createImportTransaction(String supplier, String invoiceNumber, 
        ...
        try {
            ...
            for (ImportItem item : importItems) {
                ...
                materialImport.setSupplier(supplier);
                ...
                material.setUnitPrice(item.getUnitPrice()); // Update latest price
                ...
                boolean stockLogCreated = stockLogDAO.logImport(
                    ...
                    createdBy,
                    "Nhập kho từ " + supplier + (invoiceNumber != null ? " (HĐ: " + invoiceNumber + ")" : "")
                );
