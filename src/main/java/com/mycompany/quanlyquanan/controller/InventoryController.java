    ...
    */
    ...
    public boolean createImportTransaction(String supplier, String invoiceNumber, 
        ...
        try {
            ...
            for (ImportItem item : importItems) {
                ...
                material.setPricePerUnit(item.getUnitPrice()); // Update latest price - Sử dụng setPricePerUnit thay vì setUnitPrice
                // BỎ dòng này vì bảng materials không có cột supplier:
                // material.setSupplier(supplier); ❌
                // BỎ dòng này vì bảng materials không có cột updated_by:
    ...
    public boolean createStockTransaction(int materialId, StockLog.ChangeType transactionType,
        ...
        try {
            ...
            throw new RuntimeException("Không thể thực hiện giao dịch kho", e);
        }
    }
