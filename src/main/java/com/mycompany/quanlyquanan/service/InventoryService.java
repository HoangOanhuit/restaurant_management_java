...
public class InventoryService {
    ...
    public InventoryService(MaterialDAO materialDAO, StockLogDAO stockLogDAO, MaterialImportDAO materialImportDAO, RecipeDAO recipeDAO) {
    ...
    */
    ...
    public InventoryOverview getInventoryOverview() {
        ...
        return new InventoryOverview(
            ...
            categoryCount, topValueMaterials
        );
    }
        ...
        try {
            ...
            if (success) {
                ...
                if (unitCost != null && unitCost.compareTo(BigDecimal.ZERO) > 0) {
                    materialDAO.updateUnitPrice(materialId, unitCost);
                }
    ...
    public static class InventoryOverview {
        ...
        public InventoryOverview(long totalMaterials, long lowStockCount, long outOfStockCount,
                               BigDecimal totalValue, Map<String, Long> categoryCount,
                               List<Material> topValueMaterials) {
