...
public class Material {
    ...
    private String category; // Danh mục nguyên liệu
    ...
    public Material(int id, String name, String category, String unit, BigDecimal quantity,
               BigDecimal pricePerUnit, BigDecimal threshold, boolean isActive,
