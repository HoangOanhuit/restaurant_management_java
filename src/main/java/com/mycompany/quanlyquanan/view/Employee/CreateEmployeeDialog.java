...
public class CreateEmployeeDialog extends javax.swing.JDialog {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CreateEmployeeDialog.class.getName());
    ...
    public CreateEmployeeDialog(java.awt.Frame parent, boolean modal, QuanLyNhanVienPanel parentPanel) {
        super(parent, modal);
        initComponents();
        ...
        if (controller.save(emp)) {
            ...
            SwingWorker<Void, Void> worker = new SwingWorker<>() {
                ...
                protected Void doInBackground() throws Exception {
                    MailerService.getInstance().sendPasswordResetMail(emp.getEmail(), "Mật Khẩu Đăng Nhập ", passOrg);
                    return null;
                }

//                @Override
//                protected void done() {
//                    JOptionPane.showMessageDialog(null, "Đã gửi mật khẩu mới tới email: " + email);
//                }
            };
            worker.execute();
            ...
            JOptionPane.showMessageDialog(parentPanel, "Thêm nhân viên thất bại!");
        }
