...
public class EditUserDialog extends javax.swing.JDialog {
     ...
     */
    private UserProfilePanel parentPanel;
    private Employee selectedEmp;
    private String savedImagePath = null;
    private EmployeeController controller = new EmployeeController();

    public EditUserDialog(java.awt.Frame parent, boolean modal, UserProfilePanel parentPanel, Employee emp) {
        super(parent, modal);
        initComponents();
    ...
    private void loadData(Employee emp) {
        ...
        System.out.println(emp.getAvatar() != null && !emp.getAvatar().isEmpty());
        // Hiển thị ảnh
    ...
    private void initComponents() {
        ...
        ipPosition.setEditable(false);
        ipPosition.setEnabled(false);
    ...
    private void bntAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bntAddMouseClicked
        ...
        if (selectedImageFile != null) {
            ...
            emp.setAvatar(selectedEmp.getAvatar()); 
        }
        ...
        if (controller.update(emp)) {
            ...
            Session.getInstance().setCurrentUser(emp);
            parentPanel.setSelectedEmp(emp);
